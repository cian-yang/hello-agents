...
![1777940357930](image/1777940357930.png)
...
![1777967478696](image/1777967478696.png)



**目标** ：防止策略更新过大，避免新策略偏离参考策略太远，从而“忘记”原本学到的知识（如 SFT 阶段学到的推理能力）。

KL 散度在 GRPO 中是衡量当前策略与参考策略差异的指标，通过在损失函数中加入 KL 惩罚，可以限制策略更新幅度，防止策略过度偏离参考模型，从而保持训练稳定并保留 SFT 学到的知识。
...
![1777967703565](image/1777967703565.png)
